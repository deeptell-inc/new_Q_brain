...
qbscreen/                    the package
  ...
  tests/                     246 tests: solver, capacity bound, estimators, claim-binding and table-row regressions (capacity and SD cells, input-parameter table, cross-document table references; derived-time and raw-IPC columns not yet bound)
